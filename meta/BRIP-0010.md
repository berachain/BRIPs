...
|---|---|---|
| EIP-6110 | deposits catchup logic + Fulu setup | custom deposit event parser |
| EIP-7951 (P-256) | -- | revm bump + Osaka config |
| Code size limit | -- | `CfgEnv` override |
| EIP-7939 (CLZ) | -- | revm bump + Osaka config |
| EIP-7823/7883 (MODEXP) | -- | revm bump + Osaka config |
| EIP-7934/7825 (size caps) | -- | validation checks |
| BRIP-0008 (hysteresis) | `mainnet.go` constants | -- |
| PoL vNext | `mainnet.go` inflation params | -- |
