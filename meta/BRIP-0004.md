...
- **Access control**: Only the execution layer (system address) can call this simplified version
...
3. Implement `onlyExecutionLayer` modifier to restrict access to the system
...
Building on the foundation established in PR #26, the Geth and Reth execution layer implementations will:
...
- Add `onlyExecutionLayer` access controls for the new function variant
