...
- **Hot Key Separation**: Validators can delegate cutting board updates to a separate "hot key" (`valRewardAllocator`) while keeping their reward-receiving "cold key" (`operator`) secure and offline
